...
```{r album-covers, fig.cap="From left to right: RED by Taylor Swift, Short n' Sweet by Sabrina Carpenter, Dirty Deeds Done Dirt Cheap by AC/DC, Arrival by ABBA.", out.width='24%', fig.align='center'}
knitr::include_graphics(c(
  "../data/clean/images/5ybJm6GczjQOgTqmJ0BomP.png",
  "../data/clean/images/0lBwoEOqZNwm07Pd8Hwj3L.png",
  "../data/clean/images/2d4e45fmUnguxh6yqC7gNT.png",
  "../data/clean/images/0GjEhVFGZW8afUYGChu3Rr.png"
))
```
...
```{r}
song_km <- kmeans(clustering_data, centers=5)
```

To inspect these clusters we will start by creating boxplots
...
No pattern seems to emerge from the k-means clustering.
